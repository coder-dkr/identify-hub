...
const Services = () => {
    return (
        <section id="Services" className='flex flex-col items-center '>
            ...
            <div className='flex flex-col md:flex-row justify-between items-center gap-4 md:gap-12 mt-14 text-[#CAD1E9]'>
                   ...
                   <ScaleFadewrapper key={i} time={i/5}> 
                     <div className='relative flex items-center justify-center'> 
                        ...
                        <div className='absolute top-4 left-8 flex flex-col justify-center items-start gap-3'>
                            ...
                            <p className='text-sm font-thin'>{item.sub}</p>
    
                            <button className='flex justify-center items-center text-white font-mono'>Explore More <ChevronRight className='w-5'/></button>
                     </div>
                    </div>
                   </ScaleFadewrapper>
                ))}
